...
E.g population timeseries with no rewiring allowed.

![image](timeseries_norewiring.png)

And: timeseries with extinction rewiring allowed (consumers can rewire when their last prey goes extinct)

![image](timeseries_rewiring.png)
...
- I still need to figure out "reasonable" parameter choices - e.g. choices that recover the findings of Gilljam and Kondoh in each scenario, and how to balance those mechanisms. Currently adapting/rewiring seems to drive the system to an equilibrium very quickly. Also not clear yet what the most 'important' parameters are to induce qualitative changes in the behaviour of the system.
